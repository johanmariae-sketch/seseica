...
export const HeroScrollVideo: React.FC<HeroScrollVideoProps> = ({
  title = "SESEICA",
  subtitle = "Soluciones en Sellado Industrial",
  meta = "Desde 1998 • República Dominicana",
  credits = (
    <>
      <p>Distribución y Representación</p>
      <p>de Productos Industriales</p>
    </>
  ),
  ...
  overlay = {
    caption: "SESEICA • INDUSTRIAL",
    heading: "Calidad en Movimiento",
    paragraphs: [
      "Más de 25 años distribuyendo soluciones de sellado y transferencia de fluidos para la industria.",
      "Bombas centrífugas, sellos mecánicos, empaquetaduras, juntas espirometálicas y más.",
    ],
    extra: null,
  },
    ...
    (async () => {
      ...
      try {
        ...
        CustomEase =
          ...
          CustomEasePkg;
        if (CustomEase) CustomEaseLoaded = true;
      } catch {
        // CustomEase not available, continue without it
      }

      const plugins = CustomEaseLoaded ? [ScrollTrigger, CustomEase] : [ScrollTrigger];
      ...
      if (smoothScroll) {
        try {
          ...
          // Lenis not available, continuing without smooth scroll
        }
        if (LenisCtor) {
          lenis = new LenisCtor({
            duration: 0.8,
  ...
  const renderMedia = () => {
    if (mediaType === "image") {
      ...
      return (
        <img
          src={src}
          alt="SESEICA - Soluciones en sellado industrial"
    ...
    >
      ...
      <style>{`
        .hsv-root {
          ...
          --text: #f1f5f9;
          --muted: #94a3b8;
          --muted-bg: rgba(30,58,95,0.15);
          --muted-border: rgba(30,58,95,0.3);
          --overlay-bg: rgba(10,15,26,0.55);
          --overlay-text: #ffffff;
          --accent: #C41E24;
          --accent-2: #1e3a5f;
          ...
          background: var(--bg);
          color: var(--text);
          font-family: 'Poppins', 'Open Sans', ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif;
          overflow-x: clip;
        }
        ...
        .hsv-title {
          ...
          text-wrap: balance;
          background: linear-gradient(90deg, #ffffff 0%, #ffffff 30%, #C41E24 60%, #1e3a5f 100%);
        ...
        .hsv-meta::before {
          ...
          height: 8px;
          border-radius: 999px;
          background: linear-gradient(135deg, #C41E24, #1e3a5f);
        ...
        .hsv-overlay-content h3 {
          ...
          background: linear-gradient(90deg, #fff 0%, #fff 40%, #C41E24 100%);
          -webkit-background-clip: text;
          background-clip: text;
          color: transparent;
          text-wrap: balance;
        ...
        .hsv-overlay-content h3::after {
          ...
          background: linear-gradient(90deg, #C41E24, #1e3a5f);
          opacity: 0.9;
        }
